 ...
 *
 * @param {Object} opts
 * @param {String} [opts.basePath=process.cwd()] - The base path of the app.
...
Foso.prototype.register = function(plugins, opts) {
  let promise = new Promise(function(resolve, reject) {
    ...
    opts.basePath = opts.basePath || path.resolve(process.cwd());
    opts.src = normalize(path.resolve(opts.basePath, opts.src || './'));
    opts.dest = normalize(path.resolve(opts.basePath, opts.dest || './dist'));
